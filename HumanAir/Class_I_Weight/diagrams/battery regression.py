...
ax[0].plot(x_data, regressor_poly.predict(x_data_poly), color='green', markersize = 1, linewidth = 3, alpha = 0.7, label= '$Polynomial$')
...
ax[1].plot(x_data, regressor_poly.predict(x_data_poly), color='green', markersize = 1, linewidth = 3, alpha = 0.7, label= '$Polynomial$')
...
ax[2].plot(x_data, regressor_poly.predict(x_data_poly), color='green', markersize = 1, linewidth = 3, alpha = 0.7, label= '$Polynomial$')
