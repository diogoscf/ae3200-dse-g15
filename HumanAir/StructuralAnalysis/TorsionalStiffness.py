...
class TorsionalStiffness:
    ...
    def chord(self):
        ...
        chord_length = (
            2 * self.Sw / (1 + self.taper_ratio) / self.b * (1 - ((1 - self.taper_ratio) / self.b * np.abs(2 * y)))
        )
...
torisonal_stiffness = TorsionalStiffness(
    file_path, file_path_y, Sw, taper_ratio, AoA, n, t1_spar, t2_spar, t_skin, x_pos, A_str, Cr, b
)
