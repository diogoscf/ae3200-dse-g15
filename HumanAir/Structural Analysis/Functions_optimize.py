...
torsional_stiffness = TorsionalStiffness(file_path, file_path_y, Sw, taper_ratio, AoA, n_fullspan, t1_spar, t2_spar, t_skin, x_pos, A_str, Cr, b)
...
solution = minimize(objective, t0, args=(htot, wtot, rho, b, n_halfspan, A_str), method='SLSQP', bounds=bounds, constraints=constraints)
