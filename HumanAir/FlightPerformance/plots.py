...
def plot_climb_gradient(acf):
    ...
    print(
        f"Sea level MTOW max climb gradient, clean config: {max_gradient_clean[0][0]:.3f} % at V={max_gradient_clean[0][1]:.2f}"
    )
    print(
        f"Sea level MTOW max climb gradient, gear up, take-off flaps: {max_gradient_TO[0][0]:.3f} % at V={max_gradient_TO[0][1]:.2f}"
    )
    print(
        f"Sea level MTOW max climb gradient, gear down, landing flaps: {max_gradient_land[0][0]:.3f} % at V={max_gradient_land[0][1]:.2f}"
    )
