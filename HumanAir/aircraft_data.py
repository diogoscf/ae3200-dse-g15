...
cl_wing_filepath = os.path.join(os.path.dirname(__file__), "AerodynamicData", "wing_Cl_DATA.txt")
cm_wing_filepath = os.path.join(os.path.dirname(__file__), "AerodynamicData", "wing_Cm_DATA.txt")
cdi_wing_filepath = os.path.join(os.path.dirname(__file__), "AerodynamicData", "wing_Cdi_DATA.txt")
