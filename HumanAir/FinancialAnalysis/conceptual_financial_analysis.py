...
from CO2_Calculator.conceptual_co2 import _calculate_new_co2_flight_lengths, calculate_mission_freqs
...
if __name__ == "__main__":
    ...
    input = {
        ...
        "aircraft_data": {'name': 'final_design', 'pretty_name': 'Final Design', 'MTOW_N': 15269, 'OEW_N': 8816,
                          ...
                          "Weights": {"MFW_N": 1390},
                          "Power_prop": {"E_bat_Wh": 186451, "P_req_cruise_W": 217309, "E_fuel_Wh/kg": 11972,
                                         "eta_generator": 0.45, "eta_electricmotor": 0.925, "eta_powertrain": 0.9216}}
    }
