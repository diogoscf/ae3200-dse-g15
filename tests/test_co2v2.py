...
from HumanAir.CO2_Calculator.co2v2 import calculate_co2_reduction_flightdist, calculate_new_co2_flightdist, calculate_standard_co2_flightdist
...
def test_calculate_new_co2_flightdist():
    ...
    expected_co2 = 0.135
    actual_co2 = calculate_new_co2_flightdist(flightdist=np.array([1,1,1]), mission_freqs=np.array([[1,1,1], [1,1,1]]))
